...
import { ChevronDown, Download, FileText, Globe, Check } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold">
              Okidoki <span className="text-slate-400">×</span> SuperDoc
            </h1>
        ...
        <div className="flex items-center gap-4">
                ...
                {specializations.map(spec => (
                  <button
                    ...
                    className={`w-full px-4 py-3 text-left hover:bg-slate-50 transition-colors ${
                      spec.id === currentSpecialization.id ? 'bg-teal-50' : ''
                    }`}
                  >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-sm font-medium ${isSelected ? 'text-teal-600' : 'text-slate-900'}`}>
                          {lang.name}
                        </span>
                      </div>
                      {isSelected && (
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-teal-600 hover:bg-teal-500 disabled:bg-teal-800 disabled:cursor-not-allowed rounded-lg transition-colors"
          >
            {isDownloading ? (
